...
const scouterNames = [
  ...
  { label: 'Connor Lee', value: 'Connor Lee' },
  { label: 'Joycelyn Zhou', value: 'Joycelyn Zhou' },
  { label: 'Kaitlin Ye', value: 'Kaitlin Ye' },
  { label: 'Amahl Agrawal', value: 'Amahl Agrawal' },
  { label: 'Amelia Kissner-Colohan', value: 'Amelia Kissner-Colohan' },
  { label: 'Anish Pudipeddi', value: 'Anish Pudipeddi' },
  { label: 'Arnav Kamath', value: 'Arnav Kamath' },
  { label: 'Calista Chow-Gregory', value: 'Calista Chow-Gregory' },
  { label: 'Conrad Lui', value: 'Conrad Lui' },
  { label: 'Cristina Ye', value: 'Cristina Ye' },
  { label: 'Darsh Anaparti', value: 'Darsh Anaparti' },
  { label: 'Divya Pabba', value: 'Divya Pabba' },
  { label: 'Fitch Griffin', value: 'Fitch Griffin' },
  { label: 'Jonathan Tang', value: 'Jonathan Tang' },
  { label: 'Kseniia Balashova', value: 'Kseniia Balashova' },
  { label: 'Olivia Cho', value: 'Olivia Cho' },
  { label: 'Owen Reiss', value: 'Owen Reiss' },
  ...
  { label: 'Sidhant Vats', value: 'Sidhant Vats' },
  { label: 'Swarat Parab', value: 'Swarat Parab' },
  { label: 'Tanmay Adya', value: 'Tanmay Adya' },
  { label: 'Andrew Fan', value: 'Andrew Fan' },
  { label: 'Arunav Ramanathan', value: 'Arunav Ramanathan' },
  { label: 'Brooke Chandler', value: 'Brooke Chandler' },
  { label: 'Hana Kapadia', value: 'Hana Kapadia' },
  { label: 'Jack Hou', value: 'Jack Hou' },
  { label: 'Jennifer Yang', value: 'Jennifer Yang' },
  { label: 'Maxwell Liu', value: 'Maxwell Liu' },
  { label: 'Nathan Hunt', value: 'Nathan Hunt' },
  { label: 'Reed Truong', value: 'Reed Truong' },
  { label: 'Samarth Karnam', value: 'Samarth Karnam' },
